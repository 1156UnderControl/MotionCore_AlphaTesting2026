 ...
 */
public class A301_test1 extends TimedRobot {
  private static final String kDefaultAuto = "Default";
  private static final String kCustomAuto = "My Auto";
  private String autoSelected;
  private final SendableChooser<String> chooser = new SendableChooser<>();

  private final A301 motor = new A301(CANBusMap.CAN_D10);
  ...
  public void teleopPeriodic() {
    motor.setThrottle(gamepad1.getLeftY());
   
    
      if (gamepad1.getDpadDownButton()) {
        motor.setRelativePosition(5);
      }
      if (gamepad1.getDpadUpButton()) {
        motor.setRelativePosition(0);
      }
